...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    hdma_tim8_ch3.Init.PeriphDataAlignment = DMA_PDATAALIGN_BYTE;
    hdma_tim8_ch3.Init.MemDataAlignment = DMA_MDATAALIGN_BYTE;
    ...
    __HAL_LINKDMA(tim_pwmHandle,hdma[TIM_DMA_ID_CC3],hdma_tim8_ch3);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = TIM1_CH1_HB_LED_1_Pin|TIM1_CH2_HB_LED_2_Pin|TIM1_CH3_HB_LED_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = TIM8_CH3_NEOPIXEL_Pin|TIM8_CH4_IR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(TIM3_CH4_GPS_PPS_GPIO_Port, TIM3_CH4_GPS_PPS_Pin);
